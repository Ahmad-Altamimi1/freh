      ...
      <div className='mx-auto max-w-3xl space-y-8'>
        ...
        <section>
          ...
          <p className='text-muted-foreground text-base leading-relaxed'>
            ...
            to handle user authentication securely. All authentication processes, including sign-in,
            session handling, and password management, are managed by Supabase Auth. For detailed
