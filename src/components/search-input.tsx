  ...
  return (
    <div className='w-full space-y-2'>
      ...
      >
        ...
        <kbd
          dir='ltr'
          className='bg-muted pointer-events-none absolute end-[0.3rem] top-[0.3rem] hidden h-6 items-center gap-1 rounded border px-1.5 font-mono text-[10px] font-medium opacity-100 select-none sm:flex'
        >
